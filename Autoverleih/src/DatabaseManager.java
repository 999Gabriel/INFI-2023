...
public class DatabaseManager {
    private static final String DATABASE_URL = "jdbc:mysql://localhost:3306/autoverleih_db?user=root&password=macintosh&useSSL=false&serverTimezone=Europe/Berlin";
